...
class ZoroParser:
    ...
    def __init__(self, Program_Stream):
        ...
        # print("\n\nTokens from Lexer", self.Token_Seq,"\n") # UNCOMMENT ONLY IF THE LEXER BECOMES SENTIENT AND POSES THREAT TO HUMANITY
        ...
        # for i in self.Parsed_AST.seq: pprint(i); #REFER TO SENTIENT LEXER COMMENT FOR INSTRUCTIONS
    def advance(self):                          # Moves the pointer to the immidiate next token
        # print("advancing", self.next_token()); # UNCOMMENT ONLY IF DORMAMU WILL ENGULF THE MULTIVERSE IF NOT DONE SO
        self.pos += 1
        return
    def retreat(self):                          # Moves the pointer to the immidiate previous token
        # print("retreating", self.next_token()); # BECAUSE DR. STRANGE SAID SO
        self.pos-=1
        return
    ...
    def parse_Expr(self, real_expr_flag=True, inloop=False):
        ...
        match self.next_token():
            ...
            case _:
                ...
                # self.debug_print(); # REFER TO SENTINEL ISLAND COMMENT
    ...
    def parse_Program(self):    # Program refers to the sequence of instuctions, must followed by an EOF token! 
        ...
        # print("\n\n",Sequence(final_instrs),"\n\n") # UNCOMMENT IF GONE WRONG SOMEWHERE
    ...
    # def debug_print(self): print(f"(Pos , Next_Token)     =     ({self.pos} , {self.next_token()})") # UNCOMMENT ONLY IF THE SENTIENT LEXER MAKES AN ARMY TO NORTH SENTINEL ISLANDS TO RETRIEVE THE SECRETS TO MAKE THE PARSER SENTIENT TOO
...
def test_parse():
    # print("\n") # LORD VISHNU WILL COME AMONGST THE MORTALS AS KALKI TO UNCOMMENT THIS, TILL THEN, DON'T TOUCH IT, OR MR. BEAN WILL COME AND TICKLE YOU
    ...
    if(1):      # while & for - loops statements
        ...
        # (ZoroParser("var l <- [1, 2, 3]; print l.at 2;"))
        pass
    ...
    # print("\n") # UNCOMMENT WHEN POPATLAL GETS MARRIED
test_parse()
